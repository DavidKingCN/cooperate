...
import io.dk.tio.server.WebsocketPacket.Opcode;
...
public class WebsocketDecoder
{
	...
	public static WebsocketPacket decode(ByteBuffer buf, ChannelContext<BarrageSessionContext, BarragePacket, Object> channelContext) throws AioDecodeException
	{
		//第一阶段解析
